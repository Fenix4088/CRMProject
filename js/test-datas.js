const generateTestDatas = (() => {
    ...
    const clientsArray = [
        ...
        new Client("html", "Добрыня", "Никитич", "38719231058", "dobrunia@mail.ua"),

        new Client("js", "Елена", "Пчелка", "76739230008", "elena@mail.ua"),
        new Client("js", "Анастасия", "Волочкова", "98297733298", "nastia@mail.us"),
        new Client("js", "Егор", "Плясов", "10796234091", "yehor@mail.ru"),

        new Client("vue", "Александр", "Достоевский", "48793583099", "aleksandr@mail.bl"),
        ...
        new Client("wordpress", "Евгения", "Иванова", "38792233098", "genia@mail.ua"),
        new Client("wordpress", "Лариса", "Ларина", "38722233098", "laracroft@mail.pl"),
        new Client("wordpress", "Сергей", "Долматов", "71199233091", "dolmatov@mail.ua"),
    ];
